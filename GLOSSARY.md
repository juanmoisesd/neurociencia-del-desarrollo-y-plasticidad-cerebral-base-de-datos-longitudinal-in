...
### APA 7
> De la Serna Tuya, J. M. (2025). *Glosario de términos clave: neurociencia-del-desarrollo-y-plasticidad-cerebral-base-de-datos-longitudinal-in* [Glossary of key terms]. GitHub. https://github.com/juanmoisesd/neurociencia-del-desarrollo-y-plasticidad-cerebral-base-de-datos-longitudinal-in/blob/main/GLOSSARY.md

### BibTeX
```bibtex
@misc{delaserna2025_neurociencia_del_desarrollo_y_,
  author       = {De la Serna Tuya, Juan Moisés},
  title        = {Glosario de Términos Clave / Glossary of Key Terms: neurociencia-del-desarrollo-y-plasticidad-cerebral-base-de-datos-longitudinal-in},
  year         = {2025},
  publisher    = {GitHub},
  url          = {https://github.com/juanmoisesd/neurociencia-del-desarrollo-y-plasticidad-cerebral-base-de-datos-longitudinal-in/blob/main/GLOSSARY.md},
  note         = {ORCID: 0000-0002-8401-8018}
}
```

### Chicago
> De la Serna Tuya, Juan Moisés. "Glosario de Términos Clave: neurociencia-del-desarrollo-y-plasticidad-cerebral-base-de-datos-longitudinal-in." GitHub, 2025. https://github.com/juanmoisesd/neurociencia-del-desarrollo-y-plasticidad-cerebral-base-de-datos-longitudinal-in/blob/main/GLOSSARY.md.
